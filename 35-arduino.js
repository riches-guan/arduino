...
module.exports = function(RED) {
    ...
    RED.nodes.registerType("arduino-板",ArduinoNode);
    ...
    RED.nodes.registerType("arduino输入",DuinoNodeIn);
    ...
    RED.nodes.registerType("arduino输出",DuinoNodeOut);
